...
import * as envoy_api_v2_endpoint_endpoint_pb from "../../../envoy/api/v2/endpoint/endpoint_pb";
...
export class ClusterLoadAssignment extends jspb.Message { 
    ...
    getEndpointsList(): Array<envoy_api_v2_endpoint_endpoint_pb.LocalityLbEndpoints>;
    setEndpointsList(value: Array<envoy_api_v2_endpoint_endpoint_pb.LocalityLbEndpoints>): void;
    addEndpoints(value?: envoy_api_v2_endpoint_endpoint_pb.LocalityLbEndpoints, index?: number): envoy_api_v2_endpoint_endpoint_pb.LocalityLbEndpoints;


    getNamedEndpointsMap(): jspb.Map<string, envoy_api_v2_endpoint_endpoint_pb.Endpoint>;
...
export namespace ClusterLoadAssignment {
    export type AsObject = {
        clusterName: string,
        endpointsList: Array<envoy_api_v2_endpoint_endpoint_pb.LocalityLbEndpoints.AsObject>,

        namedEndpointsMap: Array<[string, envoy_api_v2_endpoint_endpoint_pb.Endpoint.AsObject]>,

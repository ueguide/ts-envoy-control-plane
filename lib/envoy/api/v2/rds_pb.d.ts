...
export class RouteConfiguration extends jspb.Message { 
    ...
    getVirtualHostsList(): Array<envoy_api_v2_route_route_pb.VirtualHost>;
    setVirtualHostsList(value: Array<envoy_api_v2_route_route_pb.VirtualHost>): void;
    addVirtualHosts(value?: envoy_api_v2_route_route_pb.VirtualHost, index?: number): envoy_api_v2_route_route_pb.VirtualHost;
...
export namespace RouteConfiguration {
    export type AsObject = {
        name: string,
        virtualHostsList: Array<envoy_api_v2_route_route_pb.VirtualHost.AsObject>,
        vhds?: Vhds.AsObject,

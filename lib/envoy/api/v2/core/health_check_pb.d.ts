...
// file: envoy/api/v2/core/health_check.proto
...
import * as envoy_type_http_pb from "../../../../envoy/type/http_pb";
...
export namespace HealthCheck {
    ...
    export class HttpHealthCheck extends jspb.Message { 
        ...
        getCodecClientType(): envoy_type_http_pb.CodecClientType;
        setCodecClientType(value: envoy_type_http_pb.CodecClientType): void;
    ...
    export namespace HttpHealthCheck {
        export type AsObject = {
            ...
            codecClientType: envoy_type_http_pb.CodecClientType,
        }
    }

...
// file: envoy/api/v2/core/grpc_service.proto
...
export class GrpcService extends jspb.Message { 
    ...
    getInitialMetadataList(): Array<envoy_api_v2_core_base_pb.HeaderValue>;
    setInitialMetadataList(value: Array<envoy_api_v2_core_base_pb.HeaderValue>): void;
    addInitialMetadata(value?: envoy_api_v2_core_base_pb.HeaderValue, index?: number): envoy_api_v2_core_base_pb.HeaderValue;
...
export namespace GrpcService {
    export type AsObject = {
        ...
        initialMetadataList: Array<envoy_api_v2_core_base_pb.HeaderValue.AsObject>,
    }
    ...
    export namespace GoogleGrpc {
        ...
        export class SslCredentials extends jspb.Message { 
            ...
            clearRootCerts(): void;
            getRootCerts(): envoy_api_v2_core_base_pb.DataSource | undefined;
            setRootCerts(value?: envoy_api_v2_core_base_pb.DataSource): void;
            ...
            clearCertChain(): void;
            getCertChain(): envoy_api_v2_core_base_pb.DataSource | undefined;
            setCertChain(value?: envoy_api_v2_core_base_pb.DataSource): void;
        ...
        export namespace SslCredentials {
            export type AsObject = {
                rootCerts?: envoy_api_v2_core_base_pb.DataSource.AsObject,
                privateKey?: envoy_api_v2_core_base_pb.DataSource.AsObject,
                certChain?: envoy_api_v2_core_base_pb.DataSource.AsObject,
            }
        }

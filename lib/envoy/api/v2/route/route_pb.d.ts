...
// file: envoy/api/v2/route/route.proto
...
import * as envoy_type_matcher_regex_pb from "../../../../envoy/type/matcher/regex_pb";
...
export class VirtualHost extends jspb.Message { 
    ...
    getRequireTls(): VirtualHost.TlsRequirementType;
    setRequireTls(value: VirtualHost.TlsRequirementType): void;
...
export namespace VirtualHost {
    export type AsObject = {
        ...
        requireTls: VirtualHost.TlsRequirementType,
    ...
    export enum TlsRequirementType {
    NONE = 0,
    EXTERNAL_ONLY = 1,
    ALL = 2,
    }
...
export class RouteMatch extends jspb.Message { 
    ...
    clearSafeRegex(): void;
    getSafeRegex(): envoy_type_matcher_regex_pb.RegexMatcher | undefined;
    setSafeRegex(value?: envoy_type_matcher_regex_pb.RegexMatcher): void;
...
export namespace RouteMatch {
    export type AsObject = {
        ...
        path: string,
        regex: string,
        safeRegex?: envoy_type_matcher_regex_pb.RegexMatcher.AsObject,
...
export class CorsPolicy extends jspb.Message { 
    ...
    getAllowOriginStringMatchList(): Array<envoy_type_matcher_string_pb.StringMatcher>;
    setAllowOriginStringMatchList(value: Array<envoy_type_matcher_string_pb.StringMatcher>): void;
    addAllowOriginStringMatch(value?: envoy_type_matcher_string_pb.StringMatcher, index?: number): envoy_type_matcher_string_pb.StringMatcher;
...
export namespace CorsPolicy {
    export type AsObject = {
        ...
        allowOriginStringMatchList: Array<envoy_type_matcher_string_pb.StringMatcher.AsObject>,
        allowMethods: string,
        allowHeaders: string,
...
export class RouteAction extends jspb.Message { 
    ...
    getClusterNotFoundResponseCode(): RouteAction.ClusterNotFoundResponseCode;
    setClusterNotFoundResponseCode(value: RouteAction.ClusterNotFoundResponseCode): void;
    ...
    getInternalRedirectAction(): RouteAction.InternalRedirectAction;
    setInternalRedirectAction(value: RouteAction.InternalRedirectAction): void;
...
export namespace RouteAction {
    export type AsObject = {
        ...
        clusterNotFoundResponseCode: RouteAction.ClusterNotFoundResponseCode,
        metadataMatch?: envoy_api_v2_core_base_pb.Metadata.AsObject,
        ...
        internalRedirectAction: RouteAction.InternalRedirectAction,
        hedgePolicy?: HedgePolicy.AsObject,
    }
    ...
    export enum ClusterNotFoundResponseCode {
    SERVICE_UNAVAILABLE = 0,
    NOT_FOUND = 1,
    }

    export enum InternalRedirectAction {
...
export class VirtualCluster extends jspb.Message { 
    ...
    getMethod(): envoy_api_v2_core_base_pb.RequestMethod;
    setMethod(value: envoy_api_v2_core_base_pb.RequestMethod): void;
...
export namespace VirtualCluster {
    export type AsObject = {
        ...
        headersList: Array<HeaderMatcher.AsObject>,
        name: string,
        method: envoy_api_v2_core_base_pb.RequestMethod,
    }
}
...
export class HeaderMatcher extends jspb.Message { 
    ...
    getSafeRegexMatch(): envoy_type_matcher_regex_pb.RegexMatcher | undefined;
    setSafeRegexMatch(value?: envoy_type_matcher_regex_pb.RegexMatcher): void;
...
export namespace HeaderMatcher {
    export type AsObject = {
        ...
        exactMatch: string,
        regexMatch: string,
        safeRegexMatch?: envoy_type_matcher_regex_pb.RegexMatcher.AsObject,
...
export class QueryParameterMatcher extends jspb.Message { 
    ...
    getStringMatch(): envoy_type_matcher_string_pb.StringMatcher | undefined;
    setStringMatch(value?: envoy_type_matcher_string_pb.StringMatcher): void;
...
export namespace QueryParameterMatcher {
    export type AsObject = {
        ...
        stringMatch?: envoy_type_matcher_string_pb.StringMatcher.AsObject,
        presentMatch: boolean,
    }

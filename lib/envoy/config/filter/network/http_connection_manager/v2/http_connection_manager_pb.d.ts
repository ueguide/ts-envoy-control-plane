...
export class HttpConnectionManager extends jspb.Message { 
    ...
    getRouteConfig(): envoy_api_v2_rds_pb.RouteConfiguration | undefined;
    setRouteConfig(value?: envoy_api_v2_rds_pb.RouteConfiguration): void;
...
export namespace HttpConnectionManager {
    export type AsObject = {
        ...
        statPrefix: string,
        rds?: Rds.AsObject,
        routeConfig?: envoy_api_v2_rds_pb.RouteConfiguration.AsObject,
...
export class ScopedRouteConfigurationsList extends jspb.Message { 
    ...
    getScopedRouteConfigurationsList(): Array<envoy_api_v2_srds_pb.ScopedRouteConfiguration>;
    setScopedRouteConfigurationsList(value: Array<envoy_api_v2_srds_pb.ScopedRouteConfiguration>): void;
    addScopedRouteConfigurations(value?: envoy_api_v2_srds_pb.ScopedRouteConfiguration, index?: number): envoy_api_v2_srds_pb.ScopedRouteConfiguration;
...
export namespace ScopedRouteConfigurationsList {
    export type AsObject = {
        scopedRouteConfigurationsList: Array<envoy_api_v2_srds_pb.ScopedRouteConfiguration.AsObject>,
    }
}

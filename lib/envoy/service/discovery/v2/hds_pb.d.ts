...
export class EndpointHealth extends jspb.Message { 
    ...
    hasEndpoint(): boolean;
    clearEndpoint(): void;
    getEndpoint(): envoy_api_v2_endpoint_endpoint_pb.Endpoint | undefined;
    setEndpoint(value?: envoy_api_v2_endpoint_endpoint_pb.Endpoint): void;
...
export namespace EndpointHealth {
    export type AsObject = {
        endpoint?: envoy_api_v2_endpoint_endpoint_pb.Endpoint.AsObject,
...
export class LocalityEndpoints extends jspb.Message { 
    ...
    getEndpointsList(): Array<envoy_api_v2_endpoint_endpoint_pb.Endpoint>;
    setEndpointsList(value: Array<envoy_api_v2_endpoint_endpoint_pb.Endpoint>): void;
    addEndpoints(value?: envoy_api_v2_endpoint_endpoint_pb.Endpoint, index?: number): envoy_api_v2_endpoint_endpoint_pb.Endpoint;
...
export namespace LocalityEndpoints {
    export type AsObject = {
        ...
        endpointsList: Array<envoy_api_v2_endpoint_endpoint_pb.Endpoint.AsObject>,
    }
}

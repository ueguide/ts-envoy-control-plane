...
import * as envoy_api_v2_listener_listener_pb from "../../../envoy/api/v2/listener/listener_pb";
...
export class Listener extends jspb.Message { 
    ...
    getFilterChainsList(): Array<envoy_api_v2_listener_listener_pb.FilterChain>;
    setFilterChainsList(value: Array<envoy_api_v2_listener_listener_pb.FilterChain>): void;
    addFilterChains(value?: envoy_api_v2_listener_listener_pb.FilterChain, index?: number): envoy_api_v2_listener_listener_pb.FilterChain;
    ...
    getListenerFiltersList(): Array<envoy_api_v2_listener_listener_pb.ListenerFilter>;
    setListenerFiltersList(value: Array<envoy_api_v2_listener_listener_pb.ListenerFilter>): void;
    addListenerFilters(value?: envoy_api_v2_listener_listener_pb.ListenerFilter, index?: number): envoy_api_v2_listener_listener_pb.ListenerFilter;
    ...
    getSocketOptionsList(): Array<envoy_api_v2_core_base_pb.SocketOption>;
    setSocketOptionsList(value: Array<envoy_api_v2_core_base_pb.SocketOption>): void;
    addSocketOptions(value?: envoy_api_v2_core_base_pb.SocketOption, index?: number): envoy_api_v2_core_base_pb.SocketOption;
...
export namespace Listener {
    export type AsObject = {
        ...
        filterChainsList: Array<envoy_api_v2_listener_listener_pb.FilterChain.AsObject>,
        ...
        listenerFiltersList: Array<envoy_api_v2_listener_listener_pb.ListenerFilter.AsObject>,
        ...
        socketOptionsList: Array<envoy_api_v2_core_base_pb.SocketOption.AsObject>,

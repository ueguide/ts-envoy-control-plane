...
// file: envoy/api/v2/cluster/outlier_detection.proto
...
export class OutlierDetection extends jspb.Message { 
    ...
    hasFailurePercentageThreshold(): boolean;
    clearFailurePercentageThreshold(): void;
    getFailurePercentageThreshold(): google_protobuf_wrappers_pb.UInt32Value | undefined;
    setFailurePercentageThreshold(value?: google_protobuf_wrappers_pb.UInt32Value): void;


    hasEnforcingFailurePercentage(): boolean;
    clearEnforcingFailurePercentage(): void;
    getEnforcingFailurePercentage(): google_protobuf_wrappers_pb.UInt32Value | undefined;
    setEnforcingFailurePercentage(value?: google_protobuf_wrappers_pb.UInt32Value): void;


    hasEnforcingFailurePercentageLocalOrigin(): boolean;
    clearEnforcingFailurePercentageLocalOrigin(): void;
    getEnforcingFailurePercentageLocalOrigin(): google_protobuf_wrappers_pb.UInt32Value | undefined;
    setEnforcingFailurePercentageLocalOrigin(value?: google_protobuf_wrappers_pb.UInt32Value): void;


    hasFailurePercentageMinimumHosts(): boolean;
    clearFailurePercentageMinimumHosts(): void;
    getFailurePercentageMinimumHosts(): google_protobuf_wrappers_pb.UInt32Value | undefined;
    setFailurePercentageMinimumHosts(value?: google_protobuf_wrappers_pb.UInt32Value): void;


    hasFailurePercentageRequestVolume(): boolean;
    clearFailurePercentageRequestVolume(): void;
    getFailurePercentageRequestVolume(): google_protobuf_wrappers_pb.UInt32Value | undefined;
    setFailurePercentageRequestVolume(value?: google_protobuf_wrappers_pb.UInt32Value): void;
...
export namespace OutlierDetection {
    export type AsObject = {
        ...
        failurePercentageThreshold?: google_protobuf_wrappers_pb.UInt32Value.AsObject,
        enforcingFailurePercentage?: google_protobuf_wrappers_pb.UInt32Value.AsObject,
        enforcingFailurePercentageLocalOrigin?: google_protobuf_wrappers_pb.UInt32Value.AsObject,
        failurePercentageMinimumHosts?: google_protobuf_wrappers_pb.UInt32Value.AsObject,
        failurePercentageRequestVolume?: google_protobuf_wrappers_pb.UInt32Value.AsObject,
    }
}

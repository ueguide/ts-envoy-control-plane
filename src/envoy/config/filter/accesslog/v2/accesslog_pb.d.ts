...
export class HeaderFilter extends jspb.Message { 
    ...
    hasHeader(): boolean;
    clearHeader(): void;
    getHeader(): envoy_api_v2_route_route_pb.HeaderMatcher | undefined;
    setHeader(value?: envoy_api_v2_route_route_pb.HeaderMatcher): void;
...
export namespace HeaderFilter {
    export type AsObject = {
        header?: envoy_api_v2_route_route_pb.HeaderMatcher.AsObject,
    }
}
